  ...
  <div class="bg-background text-on-surface min-h-screen font-sans">
    ...
    <aside class="fixed left-0 top-0 h-full w-60 border-r border-outline-variant bg-surface-container-lowest flex flex-col py-6 gap-2 pt-20 z-40 hidden md:flex font-sans text-sm font-medium">
      ...
      <nav class="flex-1 space-y-1 px-3">
        ...
        <router-link to="/programs" class="flex items-center gap-3 px-3 py-2 text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface transition-all rounded-lg" active-class="text-secondary bg-secondary-container/20 border-r-4 border-secondary">
        ...
        <router-link to="/pr-statistics" class="flex items-center gap-3 px-3 py-2 text-on-surface-variant hover:bg-surface-container-high hover:text-on-surface transition-all rounded-lg" active-class="text-secondary bg-secondary-container/20 border-r-4 border-secondary">
